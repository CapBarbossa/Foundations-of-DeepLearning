...
from data_generator.transformations.object_detection_2d_geometric_ops import RandomFlip_arbitrary, ResizeRandomInterp_arbitrary
...
class DataAugmentationVariableInputSize(object):
    ...
    def __init__(self,
        ...
        self.resize = ResizeRandomInterp_arbitrary(height=resize_height,
                                                   width=resize_width,
