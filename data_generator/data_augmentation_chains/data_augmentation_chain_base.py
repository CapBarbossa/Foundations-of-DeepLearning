...
from data_generator.transformations.object_detection_2d_photometric_ops import ConvertColor, ConvertDataType, ConvertTo3Channels, RandomBrightness, RandomContrast, RandomHue, RandomSaturation, RandomChannelSwap
from data_generator.transformations.object_detection_2d_patch_sampling_ops import PatchCoordinateGenerator, RandomPatch, RandomPatchInf
from data_generator.transformations.object_detection_2d_geometric_ops import ResizeRandomInterp, RandomFlip
from data_generator.transformations.object_detection_2d_image_boxes_validation_utils import BoundGenerator, BoxFilter, ImageValidator
...
class SSDExpand:
    ...
    def __init__(self, background=(0, 0, 0), labels_format={'class_id': 0, 'xmin': 1, 'ymin': 2, 'xmax': 3, 'ymax': 4}):
        '''
        Arguments:
            background (list/tuple, optional): A 3-tuple specifying the RGB color value of the
                background pixels of the translated images. 可用于黑边情况的模拟
            labels_format (dict, optional): A dictionary that defines which index in the last axis of the labels
                of an image contains which bounding box coordinate. The dictionary maps at least the keywords
                'xmin', 'ymin', 'xmax', and 'ymax' to their respective indices within last axis of the labels array.
        '''
...
class SSDPhotometricDistortions:
    ...
    def __init__(self):
        ...
        self.random_hue = RandomHue(max_delta=180, prob=0.5)
