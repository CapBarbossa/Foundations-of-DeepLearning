...
from data_generator.bounding_box_utils.bounding_box_utils import iou, convert_coordinates
...
class SSDInputEncoder:
    ...
    def __init__(self,
        ...
        Arguments:
            ...
            matching_type (str, optional): Can be either 'multi' or 'bipartite[adj.有两个部分的; 两部分组成的]'. In 'bipartite' mode, each ground truth box will
